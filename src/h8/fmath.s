...
;;; 
;;; CVS: $Id: fmath.s,v 1.1.1.1 2003/02/21 09:53:07 pj Exp $
...
.ifdef __UNSIGNED_FIXED_USED__
    ...
    ;; * UNSIGNED FIXED *
    ;; ******************
	.global	_ERIKA_uint2uf
	.global	_ERIKA_uf2uint	
	.global _ERIKA_uf_mul
	.global _ERIKA_uf_div	
					
	.equ UF_ROUND,	(1<<(ERIKA_UF_NUM_BIT_FRAC-1))			
...
_ERIKA_uf2uint:
	...
	.align 1
_ERIKA_uint2uf:   ;; transform integer i into fixed point and return it (in r0)
	    ;; r0=i	    
    .rep ERIKA_UF_NUM_BIT_FRAC	
	shll	r0l
	rotxl	r0h
...
_ERIKA_uf_mul:	
	...
	sub.w	r3,r3		
	jsr	@0x01FE	
	;; r5r6 is now a*b*2^ERIKA_UF_NUM_BIT_FRAC, so shift to obtain the right result (a*b)

    .rept ERIKA_UF_NUM_BIT_FRAC
	shlr	r5h
	rotxr	r5l
	rotxr	r6h
	rotxr	r6l	
...
_ERIKA_uf_div:
	...
	;; extend b on 32 bit
    	sub.w	r3,r3		
	;; calculate (a<<ERIKA_UF_NUM_BIT_FRAC) / b
...
.ifdef __SIGNED_FIXED_USED__
    ...
    ;; ****************
    	...
    	.global	_ERIKA_int2sf
	.global	_ERIKA_sf2int
	.global _ERIKA_sf_mul
	.global _ERIKA_sf_div
	.global _ERIKA_sf_negate

	
	.equ SF_ROUND,	(1<<(ERIKA_SF_NUM_BIT_FRAC-1))	
	
	

.ifdef __SF_TRIG_USED__

	.global _ERIKA_sf_sin
	.global _ERIKA_sf_cos
	
	.equ K,  (16-ERIKA_SF_NUM_BIT_FRAC)	   ;; shift	
	.equ K1, (1<<(16-ERIKA_SF_NUM_BIT_FRAC-1)) ;; round before shift	
	.equ Kn, (0xFFFF << ERIKA_SF_NUM_BIT_FRAC) ;; add if value is negative	

	.section .rodata

	.global	_ERIKA_sf_table_cos	
	
    _ERIKA_sf_table_cos:
        .int 1 << ERIKA_SF_NUM_BIT_FRAC	;; cos(0)=1
	...
	.int 0xFFFF << ERIKA_SF_NUM_BIT_FRAC	;; cos(180)=-1
	...
	.align 1
__sfr0mod360:	
	    ;; (called by _ERIKA_sf_ERIKA_sin, _ERIKA_sf_cos, df_trig)
...
.endif		
	...
	add.w	r1, r0	
	bt	sftrig_go0
	;; N.B. _ERIKA_sf_sin dosn't return and start calculating cos(x-90) (optimization)
...
.endif			
	...
	bhi	sftrig_go1
	;; 0 <= theta <= 180	
	mov.w	@(_ERIKA_sf_table_cos, r0), r0
	bt	sftrig_end
    sftrig_go1:
	;; 180 < theta < 360
	sub.w	r1,r1
	sub.w	r0,r1
	mov.w	@(_ERIKA_sf_table_cos+720, r1), r0	
    sftrig_end:
	rts
...
_ERIKA_sf_mul:	
    ...
    fmbeq2:						
	jsr	@0x01FE	
	;; r5r6 is now a*b*2^ERIKA_SF_NUM_BIT_FRAC, so shift to obtain the right result (a*b)
    .rept ERIKA_SF_NUM_BIT_FRAC
	shar	r5h
	rotxr	r5l
	rotxr	r6h
    ...
    .align 1
_ERIKA_sf_div:
	    ;; calculate (fa / fb) := (fa<<ERIKA_SF_NUM_BIT_FRAC)/fb and return it (in r0)
	    ;; r0=fa
	    ;; r1=fb	
	push	r4
	push	r5
	...
	mov.w	#0xFFFF,r3	
    fdbeq2:						
	;; calculate (a<<ERIKA_SF_NUM_BIT_FRAC) / b
...
.ifdef __DOUBLE_FIXED_USED__	
	...
	.global _ERIKA_int2df
	.global _ERIKA_df2int
	.global _ERIKA_df_cmp
	.global _ERIKA_df_negate	
	.global _ERIKA_df_add    
	.global _ERIKA_df_sub    	
	.global _ERIKA_df_mul	
	.global _ERIKA_df_div		
...
.ifdef __DF_TRIG_USED__	
	...
	.global	_ERIKA_df_table_cos
    _ERIKA_df_table_cos:    ;; ((90*n)) elements (here n=4: 360elements*2byte = 720bytes needed)
...
.endif
	...
	mov.w	@(_ERIKA_df_table_cos,r6), r1			;; r1 stores dfs.fp	
	bt	dftrig_end
    dftrig_go2:
	mov.w   #quad2, r3
	cmp.w	r3, r6	
	...
	sub.w	r3,r3
	sub.w	r6,r3
	mov.w	@(_ERIKA_df_table_cos+(180*n*2),r3), r1	;; r1 stores dfs.fp	
	bt	dftrig_compl
    dftrig_go3:
	mov.w   #quad3, r3
	cmp.w	r3, r6
	bcc	dftrig_go4
	;; 180 < dftheta < 270	
	mov.w	@(_ERIKA_df_table_cos-(180*n*2),r6), r1	;; r1 stores dfs.fp		
	bt	dftrig_compl
    dftrig_go4:        
	;; 270 <= dftheta < 360
	...
	sub.w	r3,r3
	sub.w	r6,r3    
	mov.w	@(_ERIKA_df_table_cos+(360*n*2),r3), r1	;; r1 stores dfs.fp	    	
	bt	dftrig_end
    dftrig_compl:
	;; dfs.ip=-1
	mov.w	#0xFFFF, r5
