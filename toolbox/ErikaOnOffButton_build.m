...
%
% CVS: $Id: ErikaOnOffButton_build.m,v 1.1 2004/06/01 16:42:38 vestrini Exp $
%

function result = ErikaOnOffButton_build

obj = 'ErikaEducational/On//Off button';
cr = sprintf('\n');
...
set_param(obj,'MaskDisplay','image(imread(''ErikaOnOffButton.tif''))');
...
set_param(obj,'MaskInitialization','ErikaOnOffButton_initialize;');
