 ...
 *
 * CVS: $Id: ErikaRunButton.c,v 1.1 2004/06/01 16:42:39 vestrini Exp $
 */

#define S_FUNCTION_NAME  ErikaRunButton
...
static void mdlRTW(SimStruct *S)
{
  ...
  if (use_interrupt(S)) {
    ssWriteRTWStrParam(S, "ErikaInterrupt", "RunButton");
    ssWriteRTWStrParam(S, "InterruptHandler", "runbutton_handler"); 
    ssWriteRTWStrParam(S, "IRQ", "RUNBUTTON_IRQ");
  }
