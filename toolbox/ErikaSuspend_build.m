...
%
% CVS: $Id: ErikaSuspend_build.m,v 1.1 2004/06/01 16:42:41 vestrini Exp $
%

function result = ErikaSuspend_build

obj = 'ErikaEducational/Suspend';
cr = sprintf('\n');
...
set_param(obj,'MaskDisplay',[ 'image(imread(''ErikaSuspend.tif''));' ...
		    , cr, 'port_label(''input'',1,''suspend'');' ...
		    , cr, 'port_label(''input'',2,''resume'');', cr ] );
