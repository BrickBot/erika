 ...
 *
 * CVS: $Id: inith8hal.c,v 1.1.1.1 2003/02/21 09:53:07 pj Exp $
 */
...
#include "code.h"
    ...
    #define STACK_MAX (THREAD_MAX+1)
    
    /* stack size (in bytes) of each stack */
    #define stack1_size  512 
    #define stack2_size  512
    #define stack3_size  512
    #define stack4_size  512
    #define stack5_size  512
